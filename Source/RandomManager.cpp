...
//You might think this is amazing.
//It's not.
//For some reason, my dumb brain decided that making functions for each type is better than using templates.
//But when I was working on this game, I had to constantly use static_cast to generate random numbers.
//I'll go back to using templates.
